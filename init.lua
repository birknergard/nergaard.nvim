...
vim.keymap.set('n', '<leader>t', '<cmd>te<CR>i', { desc = 'open terminal emulator' })
vim.keymap.set('n', '<leader>T', '<cmd>split | terminal<CR>i', { desc = 'open terminal in new split' })
vim.keymap.set('n', '<leader>O', '<cmd>vsplit<CR><cmd>split | terminal<CR><C-w><C-h>', { desc = 'open terminal in new split' })
...
require('lazy').setup({
  ...
  { -- You can easily change to a different colorscheme.
    ...
    init = function()
      ...
      vim.api.nvim_set_hl(0, 'LineNr', { fg = '#FF5757', bg = 'none' })
      vim.api.nvim_set_hl(0, 'CursorLineNr', { fg = '#FFA98A', bold = true })
    end,
  },
